...
export default function DashboardClient({
  ...
  return (
    <div className="space-y-8" dir={isRTL ? "rtl" : "ltr"}>
      {!activeShift && (
        <div className={cn("bg-red-500/10 border border-red-500/20 rounded-2xl p-4 flex flex-col items-center justify-between gap-4", isRTL ? 'sm:flex-row-reverse' : 'sm:flex-row')}>
